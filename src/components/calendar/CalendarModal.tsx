...
import { Calendar, Clock, Tag, Building2, Trash2, RotateCcw, Repeat } from 'lucide-react';
...
export interface CalendarModalProps {
  ...
  initialRecurrence?: 'one-time' | 'monthly';
...
export default function CalendarModal({
  ...
  const [recurrence, setRecurrence] = useState<'one-time' | 'monthly'>(initialRecurrence);
      ...
      <DialogContent className="max-w-sm rounded-lg border border-gray-200 bg-white p-6 font-sans text-gray-900 shadow-md transition-all duration-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            >
              <SelectTrigger
                className={`w-full rounded-md border bg-white text-xs text-gray-900 transition-all duration-150 dark:bg-gray-700 dark:text-gray-100 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-400/50`}
                aria-required="true"
              >
